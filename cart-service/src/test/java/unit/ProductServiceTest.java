 ...
 * описать ожидаемые ответы без реальной базы данных. WireMock тут неприменим,
 * потому что сервис взаимодействует с репозиторием напрямую, а не по HTTP,
 * и создание ручного тестового репозитория увеличило бы объём тестового кода.
 */
