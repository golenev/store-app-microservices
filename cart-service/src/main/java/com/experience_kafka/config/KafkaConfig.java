...
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory(
        ...
        // распределяет партиции между потоками и не позволяет двум потокам читать одну и ту же
        // партицию одновременно; если потоков больше, чем партиций, лишние потоки простаивают.
        // Порядок сообщений внутри партиции сохраняется, а разные партиции обрабатываются
        // параллельно.
    ...
    public NewTopic sendTopic() {
        ...
        // При отправке сообщения Kafka выбирает партицию по хешу ключа, а при отсутствии ключа
        // распределяет сообщения по принципу round-robin, что равномерно распределяет нагрузку.
